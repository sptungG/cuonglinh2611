  ...
  const handleSubmitForm = methodForm.handleSubmit(async (formData) => {
    try {
      ...
      if (formData.accepted === "YES") {
        ...
        const location =
          partyName == "NhaGai"
            ? "Trống Đồng Place, 2 P. Lãng Yên, Hai Bà Trưng, Hà Nội"
            : "Đội 5, Phú Thịnh, Kim Động, Hưng Yên";
        downloadIcsFile({
          title: "Lễ Cưới Văn Cường & Yến Linh",
          description:
            "Trân trọng kính mời bạn đến tham dự Lễ Thành Hôn của Văn Cường và Yến Linh. Sự hiện diện của bạn là niềm vui và vinh hạnh cho đôi uyên ương trong ngày trọng đại này.",
          location: location,
          start: start,
          end: end,
        });
