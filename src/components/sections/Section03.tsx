      ...
      <div className="relative flex flex-col items-center justify-center border-b-2 border-amber-500/20 p-4 pb-0 sm:rounded-2xl sm:border-2 sm:p-10 sm:pb-12">
        ...
        {userData?.partyName === "NhaGai" ? (
          <>
            ...
            <FadeWrapper className="text-lg underline">Thứ Bảy, ngày 23 tháng 11 năm 2024</FadeWrapper>
            <FadeWrapper className="mb-6 text-base italic">{`(Tức ngày 23 tháng 10 năm 2024 Giáp Thìn)`}</FadeWrapper>

            <FadeWrapper className="text-xl">Tại gia trung tâm tiệc cưới:</FadeWrapper>
            <FadeWrapper className="mb-10 underline">Trống Đồng Place Lãng Yên, Hà Nội</FadeWrapper>
          </>
        ) : (
          <>
            <FadeWrapper className="flex items-baseline text-neutral-500">
            ...
            {userData?.partyDay === "25/11/2024" ? (
              ...
              <>
                <FadeWrapper className="text-lg underline">Thứ Ba, ngày 26 tháng 11 năm 2024</FadeWrapper>
            ...
            <FadeWrapper className="mb-10 underline">Đội 5, Phú Thịnh, Kim Động, Hưng Yên</FadeWrapper>
          </>
        )}
