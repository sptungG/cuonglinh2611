  ...
  return (
    <>
      <section
        id="invitation"
        ref={ref}
        className={cn(Fonts.Questrial.className, "text-lg min-h-dvh relative flex flex-col items-center justify-center")}
      >
        <BgEnvelope className={scrollYProgressValue > 0.3 ? "open " : "close rounded-b-lg"}>
          <div
            className={cn(
          ...
          >
            <div className="mb-10 flex items-center max-sm:flex-col sm:mb-5">
              ...
              >
                ...
                <div className="text-center font-bold text-[#ffaa40]">Phú Thịnh, Kim Động, Hưng Yên</div>
              </MotionEffect>

              <NImage src="/images/asset2.png" alt="2611" height={0} width={306} className="max-sm:-order-1 max-sm:mb-8 sm:mx-10" />

              <MotionEffect slide={{ direction: "right" }} inView inViewOnce={false} className="flex w-[220px] flex-col max-sm:text-center">
                ...
                <div className="text-center font-bold text-[#ffaa40]">305 Phúc Tân, Hoàn Kiếm, Hà Nội</div>
              </MotionEffect>
            </div>

            <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="mb-2 text-lg font-[600]">
              TRÂN TRỌNG KÍNH MỜI
            </MotionEffect>
            ...
            {userData?.partyName === "NhaGai" ? (
              <>
                <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="flex items-baseline text-neutral-500">
                  <span>Tổ chức vào lúc</span>
                  <span className="ml-1 font-[600]">{"17 giờ 30"}</span>
                </MotionEffect>
                <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="text-lg">
                ...
                >{`(Tức ngày 23 tháng 10 năm 2024 Giáp Thìn)`}</MotionEffect>

                <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="text-xl text-gray-600">
                  Tại gia trung tâm tiệc cưới:
                </MotionEffect>
                <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="mb-10">
                ...
                {userData?.partyDay === "25/11/2024" || userData?.partyName === "NhaTraiChieu" ? (
                  <>
                    ...
                    <MotionEffect
                      ...
                      inViewOnce={false}
                      className="mb-6 text-base italic"
                    >{`(Tức ngày 25 tháng 10 năm 2024 Giáp Thìn)`}</MotionEffect>
                  </>
                ) : (
                  <>
                    <MotionEffect slide={{ direction: "left" }} inView inViewOnce={false} className="text-lg">
                    ...
                    <MotionEffect
                      ...
                      inViewOnce={false}
                      className="mb-6 text-base italic"
                    >{`(Tức ngày 26 tháng 10 năm 2024 Giáp Thìn)`}</MotionEffect>
                  </>
                )}
            ...
            <MotionEffect
              ...
              inView
              inViewOnce={false}
              className={cn(Fonts.DancingScript.className, "text-center text-2xl max-sm:mb-10")}
            >
