        ...
        <BgEnvelope className={scrollYProgressValue > 0.3 ? "open " : "close rounded-b-lg"}>
          ...
          >
            <div className="mb-10 flex items-center max-sm:flex-col sm:mb-5">
              ...
              <NImage src="/images/flower1.png" alt="2611" height={0} width={306} className="max-sm:-order-1 max-sm:mb-8 sm:mx-10" />
            ...
            <FadeWrapper className={cn(Fonts.DancingScript.className, "text-center text-2xl max-sm:mb-10")}>
