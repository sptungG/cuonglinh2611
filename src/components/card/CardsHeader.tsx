...
export const CardsHeader01 = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className="group relative z-20 flex w-[366px] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-[18px] bg-amber-500/50 p-[3px]">
        <div
