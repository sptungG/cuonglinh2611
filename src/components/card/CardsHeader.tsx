...
export const CardsHeader01 = () => {
  ...
  return (
    <m.div initial="initial" animate="animate" whileHover="hover" className="bg-dot-black/[0.2] flex size-full min-h-24 flex-1 flex-row space-x-4">
      <m.div
        variants={first}
        className="group flex w-[340px] cursor-pointer flex-col items-center justify-center rounded-2xl border border-amber-500/50 bg-white p-4"
      >
        <NImage
      ...
      <m.div className="group relative z-20 flex w-[366px] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-[18px] bg-amber-500/50 p-[3px]">
        <div
